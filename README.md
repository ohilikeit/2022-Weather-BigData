...
기상청 주최의 2022 날씨 빅데이터 콘테스트에 참여한 결과이다. 

## Introduction
날씨와 전국 심뇌혈관계질환 발생 간의 연관성을 밝히고 환자 수를 예측하는 모델을 개발한다. [날씨마루](https://bd.kma.go.kr/kma2020/svc/main.do) 플랫폼을 활용하여 모델 개발에 필요한 기상 데이터를 참가자가 직접 뽑아서 활용해야했다. 
